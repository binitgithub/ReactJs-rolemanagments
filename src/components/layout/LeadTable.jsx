      ...
      <table className="table-auto w-full mt-4 border">
        ...
        <tbody>
          {data.map((record) => (
            ...
            <span className="cursor-pointer" onClick={() => handleEdit(record)} title="Edit">
                <FontAwesomeIcon icon={faEdit} className="text-green-500 mr-2" />
            </span>
            <span className="cursor-pointer" onClick={() => handleDelete(record.id)} title="Delete">
